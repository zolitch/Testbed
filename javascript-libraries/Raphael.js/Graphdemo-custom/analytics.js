...
window.onload = function () {
    ...
    r.drawGrid(leftgutter + X * .5 + .5, topgutter + .5, width - leftgutter - X, height - topgutter - bottomgutter, 30, 12, "#333");
    var path = r.path().attr({stroke: color, "stroke-width": 4}),
        bgp = r.path().attr({stroke: "none", opacity: .3, fill: "90-#fff-#f00:50-#000"}),
        label = r.set(),
